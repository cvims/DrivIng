...
class AutoPilot(autonomous_agent_local.AutonomousAgent):
    ...
    def setup(self, path_to_conf_file, route_index=None, traffic_manager=None):
        ...
        self.track = autonomous_agent_local.Track.SENSORS
        ...
        if SAVE_PATH is not None:
            self.save_path = pathlib.Path(os.environ['SAVE_PATH']) / self.route_index
    ...
    def forecast_walkers(self, actors, ego_vehicle_location, number_of_future_frames):
        ...
        pedestrians = [
            ...
            if (ped.get_location().distance(ego_vehicle_location) < self.config.detection_radius and \
            ped.type_id != "controller.ai.walker")
        ]
    ...
    def _get_angle_to(self, current_position, current_heading, target_position):
        ...
        angle_degrees = np.float64(math.degrees(angle_radians))
