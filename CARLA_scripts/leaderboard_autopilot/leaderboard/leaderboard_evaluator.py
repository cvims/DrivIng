...
from leaderboard.envs.sensor_interface_local import SensorConfigurationInvalid
...
sensors_to_icons = {
    ...
    'sensor.camera.semantic_segmentation': 'carla_sematic_segmentation',
...
def get_weather_id(weather_conditions):
    ...
    if WORK_DIR != "":
        WORK_DIR += "/"
    LEADERBOARD_ROOT = os.environ.get("LEADERBOARD_ROOT", "")
    if LEADERBOARD_ROOT != "":
        LEADERBOARD_ROOT += "/"
    tree = ET.parse(LEADERBOARD_ROOT + 'data/weather.xml')
    root = tree.getroot()
...
class LeaderboardEvaluator(object):
    ...
    def __init__(self, args, statistics_manager):
        ...
        self.render_onscreen = int(os.environ.get("DEBUG_CHALLENGE", 0))
