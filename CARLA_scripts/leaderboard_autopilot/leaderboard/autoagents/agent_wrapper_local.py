...
from leaderboard.envs.sensor_interface_local import CallBack, OpenDriveMapReader, SpeedometerReader, SensorConfigurationInvalid
...
QUALIFIER_SENSORS_LIMITS = {
    ...
    'sensor.camera.instance_segmentation': 8,
