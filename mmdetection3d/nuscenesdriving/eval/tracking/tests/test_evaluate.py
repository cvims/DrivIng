...
class TestMain(unittest.TestCase):
    ...
    @staticmethod
    def _mock_submission(nusc: NuScenesDrivIng,
                         split: str,
    ...
    def basic_test(self,
        ...
        random.seed(42)
        np.random.seed(42)
        assert 'NuScenesDrivIng' in os.environ, 'Set NuScenesDrivIng env. variable to enable tests.'
        ...
        nusc = NuScenesDrivIng(version=version, dataroot=os.environ['NuScenesDrivIng'], verbose=False)
        ...
        nusc_eval = TrackingEval(cfg, self.res_mockup, eval_set=eval_set, output_dir=self.res_eval_folder,
                                 nusc_version=version, nusc_dataroot=os.environ['NuScenesDrivIng'], verbose=False)
